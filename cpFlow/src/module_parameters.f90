...
!>Details: This module contains parameter definitions for the cases to be solved !
!>================================================================================

module module_parameters
        REAL(8),PARAMETER :: ALPHA=1E-04            !Alpha decides stretching near wall
        INTEGER,PARAMETER :: N= 1001 	            !Number of grid points
        REAL(8),PARAMETER :: KIN_VIS=1.4725*1E-5    !m^2/s Kinematic viscosity 
        ...
        CHARACTER(len=1)  :: PLOT="N"               !automatic plotting Yes(Y) or No(N) 
