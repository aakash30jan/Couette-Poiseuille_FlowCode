#v2 
#training data only available exp data
...
case_training_data=np.zeros(((case_exp.shape[0]),2))
case_training_data[:,0]=case_exp[:,0]
case_training_data[:,1]=case_exp[:,1]
#plt.plot(case_training_data[:,0],case_training_data[:,1],'r*')

case_training_file='Case_01_training_dummy.csv'
...
df = pd.read_csv('Case_01_training_dummy.csv')
