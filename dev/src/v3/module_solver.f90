...
!====================================================================
SUBROUTINE SOLVE_CP(U,ERROR,U1,VW,H,N,LD,MD,UD,D,YPAD,YHAD,ALPHA,PGF,DYN_VIS,KIN_VIS,RHO,CONV_CRIT,OUTPUTFILE)
	IMPLICIT NONE
	INTEGER :: I,J,K,COUNTER
	INTEGER,INTENT(IN):: N
	REAL(8),INTENT(IN):: YPAD(N),H,VW,YHAD(N),ALPHA,PGF,CONV_CRIT
