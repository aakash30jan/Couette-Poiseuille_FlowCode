...
REAL(8),PARAMETER :: ALPHA=1E-8 !Alpha decides how to stretch the grid i.e. alpha=0 means homogenous grid
INTEGER,PARAMETER :: N= 1001 	!NUMBER OF NODE POINTS IN FVM
...
CHARACTER(len=15):: OUTPUTFILE="Case_01_sim.dat"
REAL(8),PARAMETER ::VW=12.84, H=66E-3,  DPDX=0.0d0		
