#======================================================================================
#>Module: autoplotting.py                                                             #
#>Details: Autoplotting script for runtime plotting of cpFlow code data               #
#======================================================================================
...
if (caseint>15):
        plt.plot(case_sim[1:,0],case_sim[1:,1],'-r',label='Simulated')        
else:
        plt.plot(case_sim[:,0],case_sim[:,1],'-r',label='Simulated')

plt.plot(case_exp[:,0],case_exp[:,1],'kx',label='Experimental')
plt.xlabel('Y/H')  
plt.ylabel('U/Vw')  
